...
public abstract class WebsiteHandler extends Service<Void> {
    ...
    private void clickElement(WebElement element) {
        ...
        try {
            ...
            // We bypass this issue (it's probably because of a staled element) by calling it via a java-script, because
            // this uses the identifier (entered in website-config) instead of the reference generated by the webdriver.
            e.printStackTrace();
            addToLog("INFO:\tDOM von Java-Skripte verändert. Es wird nun versucht über Umweg diesen dennoch zu erreichen.");
